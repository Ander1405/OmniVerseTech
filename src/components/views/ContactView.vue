              ...
              <form @submit.prevent="submitForm" class="space-y-6">
                <div>
                  ...
                  <input 
                    ...
                    class="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-primary focus:border-primary dark:bg-secondary dark:text-white"
                ...
                <button 
                  type="submit" 
                  class="w-full py-3 px-6 bg-primary hover:bg-primary-dark text-white font-medium rounded-lg shadow-md transition-colors duration-300"
            ...
            <div class="w-full md:w-1/2 bg-primary p-8 md:p-12 text-white">
              ...
              <div class="space-y-6">
                ...
                <div class="flex items-start">
                  ...
                  <div>
                    <h4 class="font-semibold mb-1">{{ translations[currentLanguage].addressLabel }}</h4>
      ...
      <div class="container mx-auto px-4">
        <div class="max-w-5xl mx-auto">
          <div class="aspect-w-16 aspect-h-9 rounded-xl overflow-hidden shadow-xl">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.0968143067466!2d-122.41941492392031!3d37.77492997128579!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8085809c6c8f4459%3A0xb10ed6d9b5050fa5!2sTwitter%20HQ!5e0!3m2!1sen!2sus!4v1648641118777!<Thinking>
I need to continue the code for the ContactView.vue file. The text was cut off in the middle of an iframe src attribute for a Google Maps embed. I'll continue from that exact point and complete the rest of the component, maintaining the same style and structure as the previous code.

The cut-off point was in the middle of a Google Maps embed URL. I'll continue the URL and then complete the iframe tag, followed by the rest of the component.
</Thinking>

f13.1!3m3!1m2!1s0x8085809c6c8f4459%3A0xb10ed6d9b5050fa5!2sTwitter%20HQ!5e0!3m2!1sen!2sus!4v1648641118777!5m2!1sen!2sus" 
              width="100%" 
              height="450" 
              style="border:0;" 
              allowfullscreen="" 
