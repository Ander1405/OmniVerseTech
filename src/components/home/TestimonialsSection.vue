<template>
  <section class="py-16 md:py-24 bg-white dark:bg-secondary transition-colors duration-300">
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto p-6 items-stretch">
        <div
            v-for="(testimonial, index) in content.items"
            :key="index"
            class="flex flex-col justify-between bg-gray-50 dark:bg-secondary-dark rounded-xl shadow-lg"
          ...
          <div class="py-4 border-t mx-4 border-gray-300">
            <div class="flex items-center">
              ...
              <div class="flex flex-col justify-center">
                <h4 class="font-bold text-gray-800 dark:text-white overflow-hidden">{{ testimonial.name }}</h4>
