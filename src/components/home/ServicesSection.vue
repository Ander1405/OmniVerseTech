          ...
          >
              <div class="bg-primary p-6 text-center relative">
                  ...
                  <div class="relative z-10">
                      ...
                      <div class="text-4xl font-bold text-white">{{ service.price }}</div>
                  </div>
              </div>
              <div class="p-6 flex flex-col flex-grow">
                  <div class="flex-grow">
                      ...
                      <ul class="space-y-3">
                          <li v-for="(feature, featureIndex) in service.features" :key="featureIndex" class="flex items-center text-gray-700 dark:text-gray-300">
                  ...
                  <!-- Botón de Más Información alineado abajo -->
                  <div class="mt-auto pt-6 rounded-xl text-center">
                      <router-link
                          :to="`/servicios#${service.id}`"
                          class="inline-block w-full py-3 bg-primary hover:bg-primary-dark text-white font-medium rounded-xl transition-colors duration-300"
                      >
